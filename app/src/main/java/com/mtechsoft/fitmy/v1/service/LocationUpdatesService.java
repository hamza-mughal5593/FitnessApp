...
//            mNotificationManager.createNotificationChannel(mChannel);
    ...
    private Notification getNotification() {
        ...
        PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, ExerciseActiveActivity.class), 0);
    ...
    private void onNewLocation(Location location) {
        Log.i(TAG, "onNewLocation: " + location + " / " + location.getAccuracy());

//        if (location.getAccuracy() < 50) {

        mLocation = location;

        String locationStr = String.format("%s,%s", String.valueOf(location.getLatitude()), String.valueOf(location.getLongitude()));

        SharedPreferences sharedPreferences = getSharedPreferences(Constants.SP_PACKAGE_NAME, MODE_PRIVATE);

        String cachedLocations = sharedPreferences.getString(Constants.SP_ACTIVITY_LOCATIONS, "");
        cachedLocations += (";" + locationStr);

        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(Constants.SP_TEMP_COORDINATE, locationStr);
